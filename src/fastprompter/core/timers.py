...
class Timer:
    ...
    __slots__ = ("id", "name", "description", "target", "repeat", "sound",
                 ...
                 "sound_rules", "auto_limit_key", "temporary",
                 "delete_after_fire")
    ...
    def __init__(self, name, target, repeat=REPEAT_NONE, sound="tick",
                 ...
                 sound_rules=None, auto_limit_key=None, temporary=False,
        ...
        self.temporary = _heal_bool(temporary, False)
        self.delete_after_fire = _heal_bool(delete_after_fire, False)
        try:
    ...
    def to_dict(self):
        return {
            ...
            "delete_after_fire": self.delete_after_fire,
        }
    ...
    def from_dict(cls, d):
        ...
        try:
            return cls(
                ...
                delete_after_fire=d.get("delete_after_fire", False),
            )
