...
class ColorConfigDialog(QDialog):
    def __init__(self, main_win):
        ...
        cc = self.main_win.data.get("custom_colors", {
            ...
            "accent": "#5a7a96", "edit_bg": "#363b40",
            "overlay_new": "#ff4444", "overlay_recent": "#ff8800",
            "overlay_day": "#ffdd00", "overlay_old": "#4488ff"
        })
        ...
        if not isinstance(cc, dict):
            cc = {"bg_main": "#1a1a1a", "bg_text": "#000000", "text_main": "#c0c0c0", "border_light": "#4d4d4d", "border_dark": "#0a0a0a", "btn_bg": "#2b2b2b", "btn_pressed": "#141414", "btn_text": "#c0c0c0", "accent": "#5a7a96", "edit_bg": "#363b40", "overlay_new": "#ff4444", "overlay_recent": "#ff8800", "overlay_day": "#ffdd00", "overlay_old": "#4488ff"}

        # Ensure default keys exist if loading an old config
        for fallback_key, fallback_val in {"edit_bg": "#363b40", "overlay_new": "#ff4444", "overlay_recent": "#ff8800", "overlay_day": "#ffdd00", "overlay_old": "#4488ff"}.items():
