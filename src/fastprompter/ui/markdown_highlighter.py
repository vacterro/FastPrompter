...
class MarkdownHighlighter(QSyntaxHighlighter):
    ...
    def update_theme(self, theme):
        # We can optionally extract colors from theme dictionary, 
        # but for now we just re-setup rules to be safe.
        self.theme = theme
        self._setup_rules()
        self.rehighlight()
    ...
    def _setup_rules(self):
        ...
        self._highlighting_rules.append((re.compile(r'\[.*?\]\(.*?\)'), link_format))
