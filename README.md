...
- The suite at v0.8.35 collects **1936 tests** — **1116 unit tests** in
  `tests/` plus **820 offscreen real-app integration/smoke tests** in
  `tests_smoke/` — and runs **1935 passed, 1 skipped** (about 20 minutes).
