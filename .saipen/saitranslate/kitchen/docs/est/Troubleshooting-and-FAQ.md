...
| Logifail | Tee | Eesmärk |
|---|---|---|
| **Taotluse logi** | `%TEMP%\fastprompter.log` | Aktiivsed seansi sündmused, hoiatused, infologid (pöörlev, max 1MB, 2 varukoopiat). |
| **Avariilogi** | `%TEMP%\fastprompter_crash.log` | Käsitlemata kriitiliste erandite üksikasjalikud jäljed faili „sys.excepthook” kaudu. |
| **Test Suite Log** | `%TEMP%\fastprompter-tests.log` | Pytesti käivitamiseks isoleeritud ajutine logi. |
