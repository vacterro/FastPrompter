...
FastPrompter — это сверхбыстрый портативный блокнот с клавиатурой и инструмент быстрого проектирования, созданный для Windows с Python 3.11+ и PyQt6.

> **Одна горячая клавиша (`Alt+X`)** вызывает блокнот на 100 ячеек под курсором мыши. Никакой установки, никакого облака, никакой телеметрии. Все состояние мгновенно сохраняется в локальной базе данных SQLite WAL.
