...
| **ウィンドウ** | **Alt+E** | ウィンドウ位置ロック切替 | メイン |
| **ウィンドウ** | **Alt+S** | 常に最前面切替 | メイン |
...
### ウィンドウ管理
**Ctrl+D** — 3 段階: Zen (最小エディタのみ) → ソロ (他のすべてのウィンドウを最小化) → 通常に戻る。**Ctrl+Q** — 7 つのスナップゾーン、FancyZone ピッカー、ユーザープリセットを循環。**Alt+E/S/D/A** — ジオメトリロック、最前面ピン、サイドバー表示、フォーカス喪失非表示切替。
