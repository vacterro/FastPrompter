...
- **status:** ready
- **critical:** false
- **summary:** FORCE-FRESH re-cut of the translation bundle against HEAD e28d5719f0079f4b5acf64ae9b01c2e2ebb81dbe: added 10 missing UI keys (export overwrite, all day calendar, gap name, etc.) from recent feature commits. Validator passes with 0 errors. 29-locale translation gap remains a named backlog.
